    ...
    <a class="navbar-brand" href="#"><img src="img/logo.png"/></a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="#">Vitual Event</a>
            </li>
            <li class="nav-item">
         ...
         <div class="social-container"><span><i class="fab fa-facebook-f"></i><span><span><i class="fab fa-twitter"></i><span><span><i class="fab fa-linkedin-in"></i><span></div>
        </div>
    </div>    
</nav>
